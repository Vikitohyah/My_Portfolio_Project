      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <View
          ...
          <View
            ...
            <AButton size={65} color={'#D66F00'} icon={'share-alt'} />
            <AButton size={90} color={'#FC7F03'} icon={'star'} />
            <AButton size={90} color={'#FFA500'} icon={'happy'} />
            <AButton size={65} color={'#FFC594'} icon={'sad'} />
          </View>
        </View>
      </View>
    );
